...
import { AlertCircle, ChevronLeft, ChevronRight, MapPin, RefreshCw } from "lucide-react";
...
export default function LocationDisasters() {
  ...
  const [locationBasedDisasters, setLocationBasedDisasters] = useState<Disaster[]>([]);
  ...
  }, [isAutoPlaying, locationBasedDisasters.length, currentSlide]);
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-100">
      ...
      <form onSubmit={handleLocationSearchSubmit} className="mb-6">
      ...
      {!isLoadingDisasters && !fetchError && currentSearchedLocation && (
        <div>
          {locationBasedDisasters.length === 0 ? (
            <div className="text-center py-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">
                  Ditemukan <span className="font-semibold text-purple-600">{locationBasedDisasters.length}</span> bencana di
                  sekitar <span className="font-semibold">{currentSearchedLocation}</span>
                </span>
              ...
              <div className="relative">
                ...
                >
                  ...
                  >
                    ...
                    {/* Main slides */}
                    {locationBasedDisasters.map((disaster: Disaster, index: number) => (
