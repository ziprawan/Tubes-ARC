...
export default function DisasterDetailModal({ isModalOpen, onModalClose, disasterData }: DisasterDetailModalProps) {
  // Efek untuk menangani scroll body ketika modal terbuka
  useEffect(() => {
    if (isModalOpen) {
    ...
    <div style={modalOverlayStyles} onClick={onModalClose}>
      <div style={modalContentStyles} onClick={(event) => event.stopPropagation()}>
        ...
        <div style={modalHeaderStyles}>
          <button onClick={onModalClose} style={closeButtonStyles} aria-label="Tutup modal">
            <X size={20} />
          </button>
          ...
          <p style={{ margin: 0, opacity: 0.9 }}>Informasi Detail Bencana</p>
        </div>
        ...
        <div style={{ padding: "1.5rem" }}>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "flex-start", marginBottom: "1rem" }}>
              ...
              <div>
                <p style={{ margin: 0, fontWeight: "500", color: "#111827" }}>{formattedLocationName}</p>
                {hasValidCoordinates && (
            ...
            <div style={{ display: "flex", alignItems: "flex-start" }}>
              ...
              <div>
                <p style={{ margin: 0, fontWeight: "500", color: "#111827" }}>{formattedIncidentDate}</p>
                <p style={{ margin: "0.25rem 0 0 0", fontSize: "0.875rem", color: "#6b7280" }}>
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            <h3 style={{ margin: "0 0 1rem 0", color: "#111827", fontWeight: "600" }}>🛡️ Tips Keselamatan</h3>
            <div
              style={{
          ...
          >
            <h3 style={{ margin: "0 0 1rem 0", color: "#dc2626", fontWeight: "600" }}>🚨 Kontak Darurat</h3>
            <div
              style={{
                display: "grid",
          ...
          >
            ...
            <p style={{ margin: "0.25rem 0 0 0" }}>Diperbarui: {new Date().toLocaleString("id-ID")}</p>
          </div>
        </div>
