...
import { MapPin, Clock, AlertTriangle, Mountain, Waves, Wind, Globe2, ExternalLink } from 'lucide-react';
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-start space-x-4 mb-4">
          ...
          <div className="flex-1 min-w-0">            <div className="flex items-center space-x-2 mb-2">
              <h3 className={`text-sm font-medium ${theme.titleColor}`}>
                {getDisasterTypeLabel(disaster.type)}
              </h3>
            </div>
