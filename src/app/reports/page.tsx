...
import { FileText, Heart, Loader2, Users } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
          {statItems.map((stat) => {
            ...
            const valueToDisplay = isLoadingStats ? (
              <Loader2 className="h-7 w-7 mx-auto animate-spin text-gray-500" />
            ) : (
              stats[stat.dataKey as keyof Stats]
            );

            return (
              <div
                key={stat.label}
                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 sm:p-6 text-center transition-all hover:shadow-xl hover:scale-105"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">Ikuti perkembangan kondisi bencana terbaru dari komunitas</p>
            </div>
            <ReportsTimeline />
          </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <a
                      ...
                      className={`block ${contact.color} text-white text-center py-2.5 px-4 rounded-lg font-medium transition-colors text-sm`}
                    >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                  Jaga informasi tetap akurat, hormati privasi, dan fokus pada solusi.
                </p>
                {isLoadingActivity ? (
                  ...
                  <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
                    {activityData.latestReport ? (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="truncate">
                          Laporan baru: <strong className="font-semibold">{activityData.latestReport.title}</strong>
                        </span>
                      </div>
                    ) : (
                    ...
                    {activityData.mostLikedReport ? (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="truncate">
                          <strong className="font-semibold">{activityData.mostLikedReport.likes} orang</strong> membantu
                          laporan &quot;{activityData.mostLikedReport.title}&quot;
                        </span>
                      </div>
                    ) : (
